...
export type DbMatchParticipant = InferSelectModel<typeof matchParticipants>;
export type DbMatchParticipantCreateParams = InferInsertModel<
  typeof matchParticipants
>;
